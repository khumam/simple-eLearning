    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="box p-3">
                    <h4>Kelola Kelas</h4>
                    <a href="<?php echo base_url('dashboard/tambahkelas'); ?>" class="btn btn-success"><i class="material-icons md-24">&#xe145;</i> Tambah Kelas</a>
                </div>
            </div>
            <div class="col-sm-12">
                    ...
                    <?php foreach ($classes as $class) { ?>
                        <div class="col-xs-4 col-sm-12 col-md-4">
                            <div class="box">
                                ...
                                <a class="md-btn md-raised md-fab md-mini m-r pos-rlt md-fab-offset pull-right white" href="<?php echo base_url('dashboard/editkelas/' . $class['id']); ?>"><i class="material-icons md-24">&#xe150;</i></a>
                                <div class="p-a">
