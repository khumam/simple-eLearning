                    ...
                    <?php } else { ?>
                        <?php foreach ($classes as $class) { ?>
                            <div class="col-xs-4 col-sm-12 col-md-4">
                                <div class="box">
                                    <div class="item dark">
                                        <a href><img src="<?php echo base_url('assets/uploads/cover/' . $class[0]['cover']); ?>" class="w-full"></a>
                                        ...
                                        <div class="bottom gd-overlay p-a-xs">
                                            <a href class="text-md block p-x-sm"><?php echo $class[0]['class_name']; ?></a>
                                        </div>
                                    ...
                                    <a class="md-btn md-raised md-fab md-mini m-r pos-rlt md-fab-offset pull-right white" href="<?php echo base_url('dashboard/detail/' . $class[0]['id']); ?>"><i class="material-icons md-24">&#xe145;</i></a>
                                    <div class="p-a">
                                        ...
                                        <div class="m-b h-2x"><a href class="_800">Kelas <?php echo $class[0]['level']; ?></a></div>
                                        <p class="h-3x"><?php echo $class[0]['description']; ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
