            ...
            <div class="col-sm-12">
                <div class="box p-3">
                    ...
                    <div class="row d-flex align-items-center justify-content-center">
                        <div class="col-sm-4">
                            <img src="<?php echo base_url('assets/images/c6.jpg'); ?>" class="w-full">
                        </div>
                        <div class="col-sm-8">
                            <h4><?php echo $class['class_name']; ?></h4>
                            <h6><?php echo $class['description']; ?></h6>
                            <a href="" class="btn btn-success mt-4">Daftar kelas ini</a>
                ...
                <ul class="list-group">
                    <?php if ($materials) { ?>
                        <?php foreach ($materials as $materi) { ?>
                            <a href="<?php echo base_url('dashboard/playcourse/' . $materi['id']); ?>">
